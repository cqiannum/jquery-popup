...
(function($, document, window, undefined) {
    ...
    var Popup = $.Popup = function(data, options) {
        ...
        this.dataPool = {
            content: [], //thie could be set by plugin
        ...
        function init() {
            ...
            if (agms === 2) {
                ...
                this.total = dataPool.content.length;
            } else if (agms === 1 || agms === 0 ) {
                alert('you need specific the popup source !');
            } 

            if (skin) {
                settings = $.extend(true,defaults,skin,options);
            } else {
    ...
    Popup.prototype = {
      ...
      _beforeshow: function() {
          ...
          $.each(comps,function(i,v) {
              components[v.name].onReady(v.options);
          });

          this.isOpened = true;
          Util.trigger('beforeshow');
      },   
      show: function(index) {
          var data,
              dataPool = this.dataPool,
